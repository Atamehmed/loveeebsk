...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "EVET DEMEK İSTEDİN BENCE?🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Elinin kaydığını düşünüyorum?🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "EHEHEHEHE LOVE U😘";
  yes.innerHTML = '<a href="">YAZ BANA <3</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
